...
import pytest
from main.buscaHorario import buscaHorario
from .MockHorarioService import MockHorarioService
...
# Testa se a sala do Kiko está no prédio correto
def test_sala_Kiko(busca):
